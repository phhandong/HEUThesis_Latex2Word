...
\texttt{\wuhao{文献\cs inlinecite\{DXM2005\}论述了什么什么，而文献\cs inlinecite\{OJP1999, kelton2002, strawderman2001, LQL1999\}则对这个那个进行了研究。}}

也可以使用模板预定义的简化形式~\verb|\lcite|~替代~\verb|\inlinecite|。例如：

文献\lcite{DXM2005}论述了什么什么，而文献\lcite{OJP1999,kelton2002,strawderman2001,LQL1999}则对这个那个进行了研究。

其实现方式为：

\texttt{\wuhao{文献\cs lcite\{DXM2005\}论述了什么什么，而文献\cs lcite\{OJP1999, kelton2002, strawderman2001, LQL1999\}则对这个那个进行了研究。}}
...
对于参考文献\lcite{OJP1999}，bib文件中文献定义是这样的：
\begin{lstlisting}
  @article{ LQL1999 ,
    title={ 康德何以步安瑟尔谟的后尘? },
    author={ 李秋零 },

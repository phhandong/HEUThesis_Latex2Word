...
%  版本：1.0.0
%  最后更新：
%  修改者：Leo LiWenhui heu_handong@163.com
%  修订者：
...
\begin{figure}[htbp]
  ...
  \subfigure[女孩A]{\subfigure{\includegraphics[keepaspectratio]{chao.jpg}}}
  \hspace{20pt}
  \subfigure{\label{fig:1b}}\addtocounter{subfigure}{-2}
  \subfigure[女孩B]{\subfigure{\includegraphics[keepaspectratio]{ren.jpg}}}
  \caption{女孩}
  \label{fig:judy}
\end{figure}
...
\begin{figure}[!h]
  ...
  \begin{minipage}{\textwidth}
    ...
    \subfigure[打高尔夫球的人~1]{\subfigure{\includegraphics[width=0.4\textwidth]{golfer}}}
    \hspace{2em}
    \subfigure{\label{golfer42}}\addtocounter{subfigure}{-2}
    \subfigure[打高尔夫球的人~2]{\subfigure{\includegraphics[width=0.4\textwidth]{golfer}}}
  \end{minipage}
  \centering
  \begin{minipage}{\textwidth}
    \centering
    \subfigure{\label{golfer43}}\addtocounter{subfigure}{-2}
    \subfigure[打高尔夫球的人~3]{\subfigure{\includegraphics[width=0.4\textwidth]{golfer}}}
    \hspace{2em}
    \subfigure{\label{golfer44}}\addtocounter{subfigure}{-2}
    \subfigure[打高尔夫球的人~4。注意，规范中没有明确规定要悬挂缩进、最后一行居中。]{\subfigure{\includegraphics[width=0.4\textwidth]{golfer}}}
  \end{minipage}
  \vspace{0.2em}
  \caption{打高尔夫球的人}
  \label{golfer4}
